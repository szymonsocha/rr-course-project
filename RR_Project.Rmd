...
Let's take a look at our dataframe as to how zminenne Route 1 through 5 look by each intermediate destination.
...
As an extension to the selected base models, this study propose another Machine Learning algorithms for flight price predictions, such as: 
