...
The results of MI scores differ from the values obtained while using Python. It shows that X variables are the most significant, while Y are not. In order to check the cause of such results, another Feature Importance technique was proposed using *caret* package - Learning Vector Quantization (LVQ) model.
